...
def evaluate(labels, predictions):
    ...
    for i in range(len(labels)):
        if labels[i] == 1:
            ...
            negatives += 1
            if labels[i] == predictions[i]:
                negatives_predicted += 1

    sensitivity = positives_predicted / positives
    specificity = negatives_predicted / negatives
